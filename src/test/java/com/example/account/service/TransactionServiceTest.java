...
class TransactionServiceTest {
    ...
    void successUseBalance() {
        ...
        //when
        TransactionDto transactionDto = transactionService.useBalance(1L, "1000000000", 1200L);

        //then
        verify(transactionRepository, times(1)).save(captor.capture());
        assertEquals(1200L, captor.getValue().getAmount());
        assertEquals(8800L, captor.getValue().getBalanceSnapshot());
    ...
    void saveFailedUseTransaction() {
        ...
        ArgumentCaptor<Transaction> captor = ArgumentCaptor.forClass(Transaction.class);
        //when
        transactionService.saveFailedUseTransaction("1000000000", 1200L);
    ...
    void cancelTransaction_tooOldTooCancel() {
        AccountUser user = AccountUser.builder()
                .id(12L)
                .name("Soi")
                .build();
